...
--  Call for update values (in case of exists)
    PERFORM SCHEMA_NAME.gw_fct_upsertmincut(v_mincut_id, null::float, null::float, null::integer, v_device, v_insert_data, v_element_type, v_id, v_cur_user);

--  Return
    RETURN  SCHEMA_NAME.gw_fct_getmincut(null, null, null, v_mincut_id::integer, v_device, v_element_type, 'lang', v_cur_user);
