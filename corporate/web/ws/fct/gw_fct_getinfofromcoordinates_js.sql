...
"data":{"x":"419534.15219828", "y":"4576491.4086902", "epsg":"25831", "active_layer":"v_edit_node", 
		...
		"editable_layer":"{}", "zoom_ratio":null, "device":3, "info_type":1, "lang":"en"}}$$);	
*/
...
BEGIN
	...
	v_active_layer :=  ((p_data ->>'data')::json->>'active_layer');
	v_visible_layer :=  ((p_data ->>'data')::json->>'visible_layer');
	v_editable_layer :=  ((p_data ->>'data')::json->>'editable_layer');
